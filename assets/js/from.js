...
submitBtn.addEventListener("click", function (e) {
	...
	if (vistarName === "" || vistarMessage === "") {
		...
		Email.send({
			...
			document.getElementById("succseTabe").style.display = "flex"
...
setTimeout(() => {
window.onload=document.querySelector(".daligBox").setAttribute("style","display:flex")
}, 5000);


document.querySelector("#colos_model_box").addEventListener("click",function(){
